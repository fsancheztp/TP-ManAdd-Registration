...
import { GridIcon, ShoppingBasket, Table2Icon, ChevronLeft, ChevronRight } from "lucide-react";
...
import "@/css/03-layouts/page.css"; // ← general page styles"
import "@/css/04-components/pagination.css"; // ← corporate pagination row
